...
time.sleep(delay)
print("You seem to have fallen in with no easy way to get out.")
...
time.sleep(delay)
print("The other, is a game of Genocide where you have to kill your way out... or die trying")
time.sleep(delay)
print("Choose wisely")
print()
time.sleep(delay)
...
time.sleep(delay / 2)
print("Staying here is certainly not wise. Follow the hallway to start your journey.")
print()
time.sleep(delay)
...
if direction == "East":
   ...
   speed = int(input("You either stand your ground or back away from the threat. How many steps do you take?"))
   if speed < 2:
   ...
   time.sleep(delay)
   print("Inside the alter is a toy knife. You grab the knife for your safety and head back into the Underground.")
